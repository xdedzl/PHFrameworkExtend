...
public class GenerateGame
{
    ...
    [MenuItem("PHFramework/RefreshGameScripts")]
    public static void GenerateGameScript()
    {
        DirectoryInfo info = new DirectoryInfo(Application.dataPath + "/PHFramework/Game");
        ...
        // 替换框架模块的属性定义
        script = Replace(script, "// Start0", "// End0", "\n" + GenerateAttribute(Assembly.Load("PHFrameworkRuntime")) + "\t");
