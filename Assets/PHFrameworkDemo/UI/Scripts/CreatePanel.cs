...
public class CreatePanel : PanelBase {
    ...
    public override void Reg()
    {
        Level = 2;
        // 按钮赋值
        groupBtn = ((this["GroupBtn"] as PHButton).button) as Button;
        teamBtn = ((this["TeamBtn"] as PHButton).button) as Button;
        commandPostBtn = ((this["CommandPostBtn"] as PHButton).button) as Button;
